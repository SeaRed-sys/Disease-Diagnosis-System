<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsertZhuanjia.aspx.cs" Inherits="admin_news_InsertZhuanjia" %>
...
<body>
    ...
    <div>
      ...
      <div class="form-group">
        <label for="username">专家用户名:</label>
    ...
    <label for="username">专家年龄:</label>
     ...
     ID="RequiredFieldValidator5" runat="server" ErrorMessage="用户年龄不能为空" 
        ControlToValidate="txtuserage" ForeColor="Red"></asp:RequiredFieldValidator>
                          ...
                          <div class="form-group">
    <label for="username">专家描述:</label>
      <asp:TextBox ID="txtuserinfor" runat="server"></asp:TextBox><asp:RequiredFieldValidator
     ID="RequiredFieldValidator8" runat="server" ErrorMessage="专家描述不能为空" 
        ControlToValidate="txtuserage" ForeColor="Red"></asp:RequiredFieldValidator>

</div>
                          <div class="form-group">
    <label for="username">专家单位:</label>
      <asp:TextBox ID="txtuserunit" runat="server"></asp:TextBox><asp:RequiredFieldValidator
     ID="RequiredFieldValidator9" runat="server" ErrorMessage="专家单位不能为空" 
        ControlToValidate="txtuserage" ForeColor="Red"></asp:RequiredFieldValidator>

</div>
                  <div class="form-group">
    <label for="username">专家性别:</label>
